      ...
      description = (html`
        <div style="text-align:left">
          <div style="margin-bottom: .5em;">
            Upon restarting the app, your Ara balance is back to 1,000 and the app won't know about your
            previously purchased and published files but they are still on your machine.
          </div>
          <div>
            Please reach out to us on <a href="https://t.me/arablocks" target="_blank">telegram</a> if you have any questions.
          </div>
        </div>
        </div>
      `)
...
function waitModalText(modalName, load = {}) {
  ...
  switch (modalName) {
    ...
    case 'deployingProxy':
      ...
      break
    case 'suggestingGasPrices':
      description = html`<div>Estimating current network gas prices</div>`
      break
...
function actionModalText(modalName) {
  ...
  switch (modalName) {
    ...
    case 'transactionError':
      ...
      description = 'There was an error processing your transaction. Please increase the gas price and try again.'
      break
  }
